...
class FluxKleinTripleConditioning:
    ...
    def encode_prompt_with_images(self, clip, prompt, latent1, latent2, latent3, 
        ...
        # 构建图像感知的提示词
        enhanced_prompt = f"[MAIN IMAGE]: Primary content to edit (size: {latent1.shape})\n"
        ...
        # 构建CONDITIONING格式 [conditioning, {"pooled_output": pooled, ...}]
        conditioning = [[cond, {"pooled_output": pooled}]]
        
        # 添加多参考图像信息到extra_patches
        # 采样器可以从这里获取参考latent信息
        ...
        conditioning[0][1]["main_latent_shape"] = latent1.shape
